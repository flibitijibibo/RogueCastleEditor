	...
	public class DragDropHelper
	{
		...
		private void DropTarget_PreviewDrop(object sender, DragEventArgs e)
		{
			...
			if (draggedItem != null)
			{
                ...
                if (this.targetItemsControl is RogueCastleEditor.MapTabControl)
                    (this.targetItemsControl as RogueCastleEditor.MapTabControl).TabsRearranged(indexRemoved, insertionIndex);
